...
public class DeckViewLayoutAlgorithm<T> {
    ...
    public void computeRects(int windowWidth, int windowHeight, Rect taskStackBounds) {
        ...
        mTaskRect.set(left, mStackRect.top,
                left + size, mStackRect.top + mStackRect.height());
    ...
    void computeMinMaxScroll(ArrayList<T> data, boolean launchedWithAltTab,
        ...
        float pBetweenAffiliateOffset = pAtBottomOfStackRect -
                screenYToCurveProgress(mStackVisibleRect.bottom - mBetweenAffiliationOffset)*0.9f;
...
//        mMaxScrollP = pAtFrontMostCardTop - ((1f - pTaskHeightOffset - pNavBarOffset));
        mMaxScrollP = 1f* (pAtFrontMostCardTop - ((1f - pTaskHeightOffset - pNavBarOffset))) - 0.6F;
        ...
        Log.w("computeMinMaxScroll","mMaxScrollP " + mMaxScrollP+"");
        Log.w("computeMinMaxScroll","mMinScrollP " + mMinScrollP+"");
        Log.w("computeMinMaxScroll","mStackVisibleRect " + mStackVisibleRect.height()+"");
    }
