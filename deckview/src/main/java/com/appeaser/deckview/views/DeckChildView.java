...
//        mContent.setBackgroundDrawable(getResources().getDrawable(R.mipmap.abc_menu_hardkey_panel_mtrl_mult));
...
//        mThumbnailView.updateClipToTaskBar(mHeaderView);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.w("onMeasure--> ","width--> "+width);
        Log.w("onMeasure--> ","height--> "+height);
        Log.w("onMeasure--> ","widthWithoutPadding--> "+widthWithoutPadding);
        Log.w("onMeasure--> ","heightWithoutPadding--> "+heightWithoutPadding);
        // Measure the content
