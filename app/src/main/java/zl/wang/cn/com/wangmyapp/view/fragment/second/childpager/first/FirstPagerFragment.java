package zl.wang.cn.com.wangmyapp.view.fragment.second.childpager.first;
...
public class FirstPagerFragment extends SupportFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_book_pager_first, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        MountainSceneView mSceneView = (MountainSceneView) view.findViewById(R.id.mountain);
        mFlyView = (FlyView) view.findViewById(R.id.flyview);
        mFlyRefreshHeader = (FlyRefreshHeader)view.findViewById(R.id.flyrefresh);
        ...
        mRefreshLayout.setOnMultiPurposeListener(new SimpleMultiPurposeListener() {
            ...
            public void onHeaderMoving(RefreshHeader header, boolean isDragging, float percent, int offset, int headerHeight, int extendHeight) {
                ...
                //rl_toobar.setTranslationY(-offset);
            }
        });
    ...
    private void updateTheme() {
        if (mThemeListener == null) {
            mThemeListener = new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    int color = ContextCompat.getColor(getActivity().getApplication(), ids[index % ids.length]);
    ...
    private void addItemData() {
        ItemData itemData = new ItemData(Color.parseColor("#FFC970"),
                R.drawable.ic_fly_refresh_smartphone, "Magic Cube Show", new Date());
    ...
    private class ItemAdapter extends RecyclerView.Adapter<ItemViewHolder> {
        ...
        public ItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = mInflater.inflate(R.layout.fly_refresh_item, viewGroup, false);
        ...
        public void onBindViewHolder(ItemViewHolder itemViewHolder, int i) {
            ...
            itemViewHolder.title.setText("一杯敬自由 一杯敬死亡");
            itemViewHolder.subTitle.setText("清醒的人最荒唐");
            itemViewHolder.title.setTextColor(getResources().getColor(ids[number]));
        }
